                                                ...
                                                <td>
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="#">
                                                                <img src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" width="64" height="64" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                        ...
                                                        <p>{{ $comment->comment }}</p>
                                                        <a target="_blank" href="{{ route('post.details', $comment->post->slug."#comment-section")  }}">Reply</a>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="{{ route('post.details', $comment->post->slug)  }}">
                                                                <img src="{{ Storage::disk('public')->url('post/'.$comment->post->image) }}" width="64" height="64" alt="">
                                                            </a>
